package com.Banking_app.jpaentities;
...
public class Account {
    ...
    @JsonIgnore
    private UserProfileJpaEntity user;
    ...
    public Account(Long accountId, UserProfileJpaEntity user, String accountNumber, AccountType accountType, AccountStatus accountStatus, Instant createdAt, BigDecimal currentBalance){
